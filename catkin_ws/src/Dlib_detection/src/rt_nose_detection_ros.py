...
class image_converter:
    ...
    def __init__(self):
        ...
        # be careful of the pwd of dat files
        self.predictor = dlib.shape_predictor('predictor_nose_2.dat')
        # predictor = dlib.shape_predictor("weight/shape_predictor_68_face_landmarks.dat")


    def find_nose(self,image, x1, y1, x2, y2):
        ...
        return image, cx, cy, left_top_x, left_top_y
        # print('Center of two nostrils are(', cx[0]+x, ' , ', cy[0]+y,'),(' , cx[1]+x, ' , ' , cy[1]+y, ')')
        # cv2.waitKey(0)
    ...
    def callback(self, data):
        ...
        if use_CUDA is True:
            ...
            faces, scores, idx = self.detector.run(img, 0)
