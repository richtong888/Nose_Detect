...
class image_converter:
    ...
    def __init__(self):
        ...
        self.image_predicted_side_pub = rospy.Publisher("/nose/color/image_predicted_side", Image)
        ...
        self.pub = rospy.Publisher('nose_detect/nose_pose_side', nose_xyz_data, queue_size=10)
        ...
        self.detector_path = "../weight/predictor_face_side_816_0515.svm"
        self.detector = dlib.simple_object_detector(detector_path)
        self.detector_cnn = dlib.cnn_face_detection_model_v1('mmod_human_face_detector.dat')
        self.predictor = dlib.shape_predictor("../weight/predictor_face_side_816_0515.dat") # be careful of the pwd of dat files
        # predictor = dlib.shape_predictor("weight/shape_predictor_68_face_landmarks.dat")

    def load_n2e_para(self):
    ...
    def callback(self, data):
        ...
        avgPA, avgPB, avganglePA = self.load_n2e_para()
        ...
        # ----image display
        cv2.imshow("face_side_detection", img)

        # rostopic publish estimated P
        ...
        try:
            ...
            self.image_predicted_side_pub.publish(self.bridge.cv2_to_imgmsg(img, "bgr8"))
...
def main(args):
    rospy.init_node('nose_xyz_side_talker', anonymous=True)    
    ic = image_converter()
