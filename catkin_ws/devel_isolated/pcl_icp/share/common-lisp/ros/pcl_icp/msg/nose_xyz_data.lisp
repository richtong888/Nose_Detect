...
(cl:defmethod cl:initialize-instance :after ((m <nose_xyz_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nose_xyz_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl_icp-msg:<nose_xyz_data> is deprecated: use pcl_icp-msg:nose_xyz_data instead.")))

(cl:ensure-generic-function 'lnx-val :lambda-list '(m))
(cl:defmethod lnx-val ((m <nose_xyz_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl_icp-msg:lnx-val is deprecated.  Use pcl_icp-msg:lnx instead.")
  (lnx m))

(cl:ensure-generic-function 'lny-val :lambda-list '(m))
(cl:defmethod lny-val ((m <nose_xyz_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl_icp-msg:lny-val is deprecated.  Use pcl_icp-msg:lny instead.")
  (lny m))

(cl:ensure-generic-function 'rnx-val :lambda-list '(m))
(cl:defmethod rnx-val ((m <nose_xyz_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl_icp-msg:rnx-val is deprecated.  Use pcl_icp-msg:rnx instead.")
  (rnx m))

(cl:ensure-generic-function 'rny-val :lambda-list '(m))
(cl:defmethod rny-val ((m <nose_xyz_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl_icp-msg:rny-val is deprecated.  Use pcl_icp-msg:rny instead.")
  (rny m))
